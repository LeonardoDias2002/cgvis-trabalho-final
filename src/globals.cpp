...
std::vector<TrackTriangle> g_PistaQuatroWallTriangles;
std::vector<TrackTriangle> g_PistaSpiralTriangles;
std::vector<TrackTriangle> g_PistaSpiralAllTriangles;
std::vector<TrackTriangle> g_PistaSpiralWallTriangles;
