...
def search_freesound(query, filename):
    ...
    try:
        ...
        # find preview link: https://cdn.freesound.org/previews/...mp3
...
import urllib.parse
search_freesound("golf hit", "data/hit.mp3")
search_freesound("park ambience birds", "data/ambiente.mp3")
search_freesound("bossa nova loop", "data/menu.mp3")
search_freesound("success jingle", "data/vitoria.mp3")
